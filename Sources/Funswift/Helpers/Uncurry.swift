...
public func uncurry<A, B, C, Output>(_ transform: @escaping (A) -> (B) -> (C) -> Output) -> (A, B, C) -> Output {
...
public func uncurry<A, B, C, D, E, F, G, H, I, Output>(
    _ transform: @escaping (A) -> (B) -> (C) -> (D) -> (E) -> (F) -> (G) -> (H) -> (I) -> Output) -> (A, B, C, D, E, F, G, H, I) -> Output {
        
        return { a,b,c,d,e,f,g,h,i in transform(a)(b)(c)(d)(e)(f)(g)(h)(i) }
}

public func uncurry<A, B, C, D, E, F, G, H, I, J, Output>(
    _ transform: @escaping (A) -> (B) -> (C) -> (D) -> (E) -> (F) -> (G) -> (H) -> (I) -> (J) -> Output) -> (A, B, C, D, E, F, G, H, I, J) -> Output {
        
        return { a,b,c,d,e,f,g,h,i,j in transform(a)(b)(c)(d)(e)(f)(g)(h)(i)(j) }
}
